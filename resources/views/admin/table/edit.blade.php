        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ url('admin/table/update', $user->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" placeholder="Masukkan name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" placeholder="Masukkan name" disabled>
                            ...
                            <a href="{{ url('admin/table/dashboard') }}" class="btn btn-md btn-success">KEMBALI</a>
